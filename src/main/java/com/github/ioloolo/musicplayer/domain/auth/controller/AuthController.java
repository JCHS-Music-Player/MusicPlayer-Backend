package com.github.ioloolo.musicplayer.domain.auth.controller;
...
import com.github.ioloolo.musicplayer.domain.auth.service.AuthService;
import com.github.ioloolo.musicplayer.domain.auth.exception.AlreadyTakenUsernameException;
import com.github.ioloolo.musicplayer.domain.auth.payload.request.LoginRequest;
import com.github.ioloolo.musicplayer.domain.auth.payload.request.RegisterRequest;
import com.github.ioloolo.musicplayer.domain.auth.payload.response.JwtResponse;
